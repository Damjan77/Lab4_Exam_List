...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<ListExam> exams = [
    ListExam(id: "D0", subject: "Strukturno programiranje", dateTime: DateTime.parse("2023-01-10 12:00:00")),
    ListExam(id: "D1", subject: "Bazi na podatoci", dateTime:  DateTime.parse("2023-01-11 13:30:00")),
    ListExam(id: "D2", subject: "Napredno programiranje", dateTime:  DateTime.parse("2023-01-12 13:00:00")),
  ];
                    ...
                    itemBuilder: (ctx, index) {
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            _modifyDate(exams[index].dateTime),
